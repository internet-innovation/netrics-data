...
- **[example-notebooks](https://github.com/internet-innovation/netrics-data/blob/main/example-notebooks)**: Find Jupyter notebooks with example code for working with the Netrics data and notebooks containing the analysis underlying some of the data stories on the portal.
...
**See the [data dictionary](https://github.com/internet-innovation/netrics-data/blob/main/documentation/netrics-data-dictionary.md)** for more information about the datasets and data.
...
- Visit our [website](https://internet-innovation.github.io/) for the initiative
...
For questions about the above, contact us at [broadband-research@lists.uchicago.edu](mailto:broadband-research@lists.uchicago.edu).

## License

<a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png" /></a><br /><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Netrics Data</span> by <a xmlns:cc="http://creativecommons.org/ns#" href="https://internet-innovation.github.io/" property="cc:attributionName" rel="cc:attributionURL">Internet Innovation Initiative</a> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Attribution-ShareAlike 4.0 International License</a>.
